...
default_args = {
    ...
    'email_on_failure': 'aderaldo.carvalho@dcx.ufpb.br',
    'email_on_retry': 'aderaldo.carvalho@dcx.ufpb.br',
    'retries': 2,
...
@dag(
    ...
    schedule_interval=timedelta(days=1),# executada a cada dia
    catchup=False
)
        ...
        def  get_max_primary_key(table_name: str):
            with SnowflakeHook(snowflake_conn_id='snowflake').get_conn() as conn:
                with conn.cursor() as cursor:
                    ...
                    max_id = cursor.fetchone()[0] # Armazenar o resultado do cursos acima
                    return max_id if max_id is not None else 0
                # retorna 0 se o valor do max_id for none
